#
#  Be sure to run `pod spec lint CocoaPodLibraryTest.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A short description of CocoaPodLibraryTest."
  ...
  s.source_files  = 'CocoaPodLibraryTest/**/*.{h,m,pch}'
